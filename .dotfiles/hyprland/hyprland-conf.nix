...

{
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      monitor = [
        "DP-3,2560x1440@179.96,0x0,1"
        "DP-2,2560x1440@144,0x-1440,1"
        "DP-1,1920x1080@240,2560x0,1,transform, 3"
        "HDMI-A-3,1024x600@59.82,1500x1440,1"
        # "DP-1,2560x1440@144,0x0,1"    # Exemple
